...
sub _get_aws_vm_matrix {
	...
	return {
		map {( $_->[0], {type_dev => $_->[1], type_prod => $_->[2], disk_size => int($_->[3]), ephemeral_dev => int($_->[4]), ephemeral_prod => int($_->[5])}) } (
			...
			[ qw[  credhub       t3.medium    r6i.large          30720           8192          16384  ] ],
			[ qw[  diego-api     t3.large     c6i.2xlarge        15360           8192          16384  ] ],
			[ qw[  diego-cell    t3.large     r6i.4xlarge       262144          65536         393216  ] ],
			[ qw[  doppler       t3.medium    c6i.xlarge         15360           8192          16384  ] ],
			[ qw[  errand        t3.medium    m6i.large          15360           8192           8192  ] ],
			...
			[ qw[  router        t3.medium    c6i.xlarge         15360           8192          16384  ] ],
			[ qw[  scheduler     t3.medium    m6i.large          15360           8192          16384  ] ],
			[ qw[  tcp-router    t3.medium    c6i.xlarge         10240           8192          16384  ] ],
			[ qw[  uaa           t3.large     c6i.large          30720           8192          16384  ] ],
			[ qw[  database      t3.medium    m6i.xlarge         61440           8192          16384  ] ],
			[ qw[  blobstore     t3.medium    m6i.large          61440           8192           8192  ] ],
